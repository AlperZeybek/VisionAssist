...
def write_onsoz(doc):
    ...
    paras = [
        ...
        "Geliştirilen sistem, daha önceki tasarım çalışmasında ortaya konulan asgari uygulanabilir ürün (Minimum Viable Product) iskeletinin üzerine inşa edilmiş; nesne tanıma yeteneği COCO veri kümesi üzerinde eğitilmiş TensorFlow Lite EfficientDet-Lite1 modeli ile zenginleştirilmiş, yön bulma yeteneği ise Açık Sokak Haritası (OpenStreetMap) tabanlı OSRM ve Nominatim servisleriyle bütünleştirilmiştir. Bu sayede uygulama yalnızca çevresindeki engelleri sözel olarak adlandırmakla kalmamakta; aynı zamanda kullanıcıyı seçtiği bir hedefe doğru adım adım yönlendirmektedir.",
...
def write_icindekiler(doc):
    ...
    rows = [
        ...
        ("        2.3.6. Donanım yapılandırma ve platform gereksinimleri", "14"),
        ("        2.3.7. Veri saklama yaklaşımı ve veritabanı kararı", "15"),
        ("    2.4. Hibrit Çevrim İçi ve Çevrim Dışı Çalışma Yapısı", "16"),
        ("    2.5. Kullanım Senaryoları ve İş Akış Diyagramları", "17"),
        ("    2.6. Fonksiyonel Gereksinimler", "18"),
        ("    2.7. Fonksiyonel Olmayan Gereksinimler", "19"),
        ("    2.8. Algoritmik Yaklaşım ve Karar Mantığı", "20"),
        ("    2.9. Modül Tasarımı ve Bileşen Sorumlulukları", "22"),
        ("    2.10. Sistem Mimarisi ve Veri Akış Diyagramı", "23"),
        ("    2.11. UML Diyagramları", "24"),
        ("    2.12. Performans Hedefleri ve Kabul Kriterleri", "25"),
        ("    2.13. Yapay Zekâ Model Seçiminin Gerekçesi ve Karşılaştırmalı Analizi", "26"),
        ("        2.13.1. COCO veri kümesinin görme engelli navigasyon için değerlendirilmesi", "27"),
        ("        2.13.2. Gelecek model yükseltme yol haritası", "28"),
        ("BÖLÜM 3. DENEY DÜZENEĞİ VE SANAL LABORATUVAR", "29"),
        ("    3.1. Deney Düzeneği", "29"),
        ("    3.2. Deney Senaryoları", "30"),
        ("        3.2.1. Çevrim dışı sokak modu senaryosu", "30"),
        ("        3.2.2. Çevrim dışı iç mekan modu senaryosu", "31"),
        ("        3.2.3. Çevrim içi navigasyon senaryosu", "32"),
        ("    3.3. Sanal Laboratuvar Ortamı", "33"),
        ("    3.4. Test Aşaması ve Değerlendirme Kriterleri", "34"),
        ("    3.5. Performans Ölçümleri", "35"),
        ("    3.6. Deneysel Bulguların Tartışılması", "36"),
        ("    3.7. Geçerlilik Tehditleri ve Sınırlılıklar", "37"),
        ("    3.8. İş Paketleri ve Zaman Planı", "38"),
        ("    3.9. Maliyet ve Enerji Analizi", "40"),
        ("        3.9.1. Geliştirme maliyet analizi", "40"),
        ("        3.9.2. Enerji tüketimi analizi", "41"),
        ("BÖLÜM 4. VERİ GÜVENLİĞİ DEĞERLENDİRMESİ", "43"),
        ("    4.1. Toplanan Veri Türleri ve Güvenlik Düzeyleri", "43"),
        ("    4.2. Veri İşleme Süreci ve Gizlilik Yaklaşımı", "44"),
        ("    4.3. Veri İletimi ve Ağ Güvenliği", "44"),
        ("    4.4. Mobil Uygulamalara Özgü Güvenlik Riskleri", "45"),
        ("    4.5. Hukuki ve Etik Değerlendirme", "45"),
        ("    4.6. Tehdit Modeli ve Saldırı Yüzeyi Analizi", "46"),
        ("    4.7. İzin Yönetimi ve Asgari Yetki İlkesi", "47"),
        ("    4.8. KVKK ve GDPR Perspektifi", "47"),
        ("    4.9. Yazılım Güvenlik Testi ve Sızma Testi", "48"),
        ("        4.9.1. Statik kod analizi", "48"),
        ("        4.9.2. Ağ trafiği incelemesi", "49"),
        ("        4.9.3. Girdi doğrulama ve enjeksiyon testi", "49"),
        ("        4.9.4. Genel güvenlik değerlendirmesi", "50"),
        ("BÖLÜM 5. SONUÇLAR VE ÖNERİLER", "51"),
        ("    5.1. Çalışmadan Elde Edilen Sonuçlar", "51"),
        ("    5.2. Akademik Katkılar", "52"),
        ("    5.3. Sınırlılıklar", "52"),
        ("    5.4. Gelecek Çalışmalar İçin Öneriler", "53"),
        ("    5.5. MVP Çıktılarının Değerlendirilmesi", "54"),
        ("    5.6. Literatürle Kıyas ve Konumlandırma", "54"),
        ("    5.7. Uygulanabilirlik ve Yaygın Etki", "55"),
        ("    5.8. Değişiklik Yönetimi", "56"),
        ("    5.9. Mühendislik Standartları", "58"),
        ("    5.10. Ticaretleşme Planı", "61"),
        ("KAYNAKLAR", "65"),
        ("EK A. EKLER", "67"),
        ("ÖZGEÇMİŞ", "71"),
        ("BSM 498 DEĞERLENDİRME VE SÖZLÜ SINAV TUTANAĞI", "72"),
    ]
...
def write_tablolar_listesi(doc):
    ...
    rows = [
        ...
        ("Tablo 2.2.", "Fonksiyonel gereksinimler", "18"),
        ("Tablo 2.3.", "Erişilebilirlik kabul kriterleri (WCAG karşılığı)", "19"),
        ("Tablo 2.4.", "Donanım yapılandırma ve platform gereksinimleri", "14"),
        ("Tablo 2.5.", "AsyncStorage anahtar-değer şeması", "15"),
        ("Tablo 2.6.", "Aday modeller karşılaştırması", "26"),
        ("Tablo 3.1.", "Ortam bazlı algılama performansı", "35"),
        ("Tablo 3.2.", "Ekip sorumlulukları", "38"),
        ("Tablo 3.3.", "İş-zaman çizelgesi (Gantt)", "39"),
        ("Tablo 3.4.", "Geliştirme maliyet analizi", "40"),
        ("Tablo 3.5.", "Çalışma durumuna göre enerji tüketimi", "41"),
        ("Tablo 4.1.", "İzin, veri ve amaç eşlemesi", "43"),
        ("Tablo 4.2.", "Güvenlik testi bulguları özeti", "49"),
        ("Tablo 5.1.", "Görme engelli mobil sistemler karşılaştırması", "54"),
        ("Tablo 5.2.", "Karşılaşılan sorunlar ve çözümleri", "53"),
    ]
    for label, desc, page in rows:
        p = add_paragraph_with_style(doc, "AnaParagrafYaziStiliSau", "")
        p.add_run(label + " ")
